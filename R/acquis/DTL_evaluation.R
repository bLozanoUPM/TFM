...
jrc_en=read.csv("/Users/borjalozanoalvarez/Projects/Library/MetricPerformance/src/main/resources/evaluation/DTL(0.5).csv")
...
figure <- annotate_figure(figure,
                top = text_grob("Disjoint Topic Levels", color = "red", face = "bold", size = 14),
